...
| Heavy-truncation tag     | If the loop ate more than the last 10% of the transcript, save as `movie-truncated.srt` | — | `--loop-near-end-pct`    |
...
The "last 10%" threshold is tunable via `--loop-near-end-pct`: set it to
